...
(function () {
  ...
  /* ---------- "Jogue Agora!" (página Jogo) ---------- */
  // O jogo em si ainda não existe (só o material de apresentação), então o
  // botão avisa isso de forma clara em vez de levar a um link quebrado.
  const playNowBtn = document.getElementById('playNowBtn');
  playNowBtn?.addEventListener('click', (e) => {
    e.preventDefault();
    playNowBtn.textContent = '';
    const label = document.createElement('span');
    label.textContent = 'Em breve — jogo em desenvolvimento';
    playNowBtn.appendChild(label);
    playNowBtn.classList.add('is-disabled');
  });
})();